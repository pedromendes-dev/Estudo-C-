...
**Public**: Visível para todos; qualquer classe pode acessar. Usado quando você quer que o método ou atributo seja aberto.
...
**Private**: Visível apenas dentro da própria classe. Usado para encapsular dados, protegendo-os de acesso externo.
...
**Protected**: Visível dentro da classe e em subclasses (herança). Usado quando você quer que apenas quem herda a classe tenha acesso.
