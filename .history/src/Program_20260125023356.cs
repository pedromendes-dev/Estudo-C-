...
// . seria a continuação de algo que já foi iniciado. No caso, o ponto está indicando que estamos acessando um membro (propriedade ou método) da classe Pessoa através do objeto p.
